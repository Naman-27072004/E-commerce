    ...
    return (
        <div className="flex flex-col mb-24">
            ...
            <div className="m-1 ">
                ...
                <Link to={ '/products/mobile phones' } className="border rounded p-10 cursor-pointer  hover:bg-orange-500  hover:text-white"><CiMobile2 size={ 50 } />Phones</Link>
                    <Link to={ '/products/Tablets' } className="border rounded p-10 cursor-pointer  hover:bg-orange-500  hover:text-white"><FiTablet size={ 50 } />Tablets</Link>
                    <Link to={ '/products/Desktop' } className="border rounded p-10 cursor-pointer  hover:bg-orange-500  hover:text-white"><HiOutlineComputerDesktop size={ 50 } />Computers</Link>
                    <Link to={ '/products/Laptops' } className="border rounded p-10 cursor-pointer  hover:bg-orange-500  hover:text-white"><CiLaptop size={ 50 } />Laptops</Link>
                    <Link to={ '/products/Smart watches' } className="border rounded p-10 cursor-pointer  hover:bg-orange-500  hover:text-white"><IoWatchOutline size={ 50 } />Watches</Link>
                </div>
            </div>
            ...
            <div className="flex justify-evenly">
                ...
                <div className=" border rounded p-5 m-5  hover:bg-orange-500  hover:text-white">
                    <VscWorkspaceTrusted size={ 50 } className="ml-[100px]" />
