...
const Signup = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full">
            <div className="flex flex-col items-left justify-center max-w-[40rem] min-w-fit -mt-40 ml-40 shadow-2xl px-4 py-10 rounded-md">
                ...
                <form onSubmit={handleSubmit} className='flex flex-col'>
                    ...
                    <input
                        ...
                        required
                    /><br />
                    <button type="submit" className="bg-orange-500 rounded text-white p-1 hover:bg-orange-600">
                        Create Account
                    </button><br />
                </form>
                <span>Already have an account? <a href="/login" className='underline'>Log in</a></span>
            </div>
        </div>
    );
};
